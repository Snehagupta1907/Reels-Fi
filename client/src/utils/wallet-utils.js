import { polygon, polygonMumbai, arbitrum,optimismSepolia,mantaSepoliaTestnet } from "wagmi/chains";
import { jsonRpcProvider } from "wagmi/providers/jsonRpc";
import { getDefaultWallets } from "@rainbow-me/rainbowkit";
import { configureChains, createConfig } from "wagmi";
const { chains, publicClient } = configureChains(
  [polygon, arbitrum, polygonMumbai,optimismSepolia,mantaSepoliaTestnet],
  [
    jsonRpcProvider({
      rpc: (chainId) => {
        if (chainId.id == 137) {
